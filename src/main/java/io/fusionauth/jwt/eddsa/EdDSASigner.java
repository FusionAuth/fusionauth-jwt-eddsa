...
public class EdDSASigner implements Signer {
  ...
  public static EdDSASigner newSigner(String privateKey) {
    return new EdDSASigner(EdDSA.Algorithm, privateKey, null, new DefaultCryptoProvider());
  }
  ...
  public byte[] sign(String message) {
    ...
    try {
      Signature signature = cryptoProvider.getSignatureInstance(algorithm.name);
